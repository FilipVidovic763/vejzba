...
class Anjctestcas(unittest.TestCase):
    ...
    def test_does_a_new_card_get_added_in_hand(self):
        ...
        self.assertEqual(len(hand),1, "ovdje imam jednu kartu u ruci")
    ...
    def test_value_of_cards_in_SPIL(self):
        ...
        self.assertEqual(card,10,"Vrijednsot Dame je 10")
        card=game_test.SPIL['Kec']
        self.assertEqual(card,1,"vrijednsot Keca je 1")
